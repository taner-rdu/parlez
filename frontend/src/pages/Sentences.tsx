...
export default function Sentences() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-8">Translate the sentence below into English.</p>

      {/* Sentence card */}
      <div className="bg-navy-900 rounded-xl px-6 py-5 mb-6 border-l-4 border-gold-500">
        <p className="text-xs font-semibold text-gold-400 uppercase tracking-wider mb-2">Translate this sentence</p>
        <p
      ...
      <div className="mb-5">
        <label className="block text-sm font-medium text-gray-600 mb-2">Your translation</label>
        <input
      ...
      {feedback !== null && (
        <div className="mt-6 bg-white rounded-xl border border-cream-200 shadow-sm px-5 py-4">
          <p className="text-xs font-semibold text-gold-500 uppercase tracking-wider mb-2">Feedback</p>
